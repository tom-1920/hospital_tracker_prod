...
def update_availability(request):
    ...
    if request.user.username != "hospital_b":
        return redirect("/")
    ...
    resources = Resource.objects.using("hospital_b_db").all()
    ...
    if request.method == "POST":
        ...
        for resource in resources:
            ...
            if value is not None:
                try:
                    ...
                    resource.save(using="hospital_b_db")
                except ValueError:
                    pass
        ...
        return redirect("hospital_b_update")
    ...
    return render(request, "hospital_b/update_availability.html", {
        "resources": resources,
        "sos": sos,
