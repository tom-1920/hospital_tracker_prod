...
HOSPITAL_NAME = "Lifeline Advanced Medical Institute"


@login_required
def update_availability(request):

    if request.user.username != "hospital_c":
        return redirect("/")
    ...
    resources = Resource.objects.using("hospital_c_db").all()
    ...
    if request.method == "POST":
        ...
        for resource in resources:
            ...
            if value is not None:
                try:
                    ...
                    resource.save(using="hospital_c_db")
                except ValueError:
                    pass
        ...
        return redirect("hospital_c_update")
    ...
    return render(request, "hospital_c/update_availability.html", {
        "resources": resources,
        "sos": sos,
